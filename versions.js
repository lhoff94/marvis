window.addEventListener('load', function() {
    ...
    var branches = ["master", "delete_old_examples", "example/diak", "fix/bash-as-default", "fix/sumo-example", "gh-pages", "improve-readme", "linting", "new-naming-marvis", "qemu_branch", "readthedocs", "renaming-v2"];
