window.addEventListener('load', function() {
    ...
    var branches = ["master", "example/diak", "fault-injection-example", "fix-no-stop-container-if-not-running", "gh-pages", "linting", "new-naming-marvis", "qemu_branch", "readthedocs", "renaming-v2", "split_workflows"];
