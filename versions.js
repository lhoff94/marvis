window.addEventListener('load', function() {
    ...
    var branches = ["master", "delete_old_examples", "example/diak", "gh-pages", "improve-readme", "linting", "new-naming-marvis", "qemu_branch", "readthedocs", "renaming-v2", "scenario-formatting"];
